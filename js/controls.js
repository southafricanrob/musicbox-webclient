...
//    }
//    if (!nwrandom) {
//        $("#randombt").attr('src', 'images/icons/random-active.png');
//    } else {
//        $("#randombt").attr('src', 'images/icons/random.png');
//    }
//    random = nwrandom;
//}

//This sets the icon color to green if active
function setRepeat(nwrepeat) {
    if (repeat == nwrepeat) {
        return
    }
    if (!nwrepeat) {
            $("#repeatbt").attr('style', 'color:#dfe0e6');
    } else {
            $("#repeatbt").attr('style', 'color:#84bd00');
...
function setRandom(nwrandom) {
    ...
    if (!nwrandom) {
        $("#randombt").attr('style', 'color:#dfe0e6');

    } else {
        $("#randombt").attr('style', 'color:#84bd00');
...
function setVolume(value) {
    ...
    $("#volumeslider2").val(value).slider('refresh');
    initgui = oldval;
}
